    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _wikiRow(widget.result.wikiSummary!, widget.result.wikiImageURL!)
        ...
        onPressed: _isSaving ? null : () async {
          ...
          try {
            ...
            final savedResult = PlantResult(
              ...
              wikiSummary: widget.result.wikiSummary,
              wikiImageURL: widget.result.wikiImageURL
            );
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (image != '')
                    GestureDetector(
                      onTap: () => _openFullImageWiki(image, widget.result.scientificName),
                      child: ClipRRect(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                final encodedTitle = Uri.encodeComponent(widget.result.scientificName);
